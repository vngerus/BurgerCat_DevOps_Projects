...
const burgers = [
    { name: 'Big Miau', image: burguerclasico, description: 'La clásica hamburguesa Big Mac, ahora con salsa especial para gatos exigentes. ¡Te hará ronronear de placer!' },
