    ...
    return (
        <div className="bg-orange-200 p-6">
            <div className="text-center mb-6">
                ...
                <p className="text-lg text-gray-700">La mejor calidad, solo en Burger Cat</p>
                <img src={promo1} alt="Promo Burger" className="my-6 rounded-lg shadow-md" />
            </div>

            <div className="my-8">
                <h2 className="text-3xl font-semibold text-gray-800">¡La Clásica de siempre por $4.990!</h2>
