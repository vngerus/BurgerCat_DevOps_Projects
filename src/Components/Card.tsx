...
const Card = () => {
  return (
    ...
    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
            <img className="rounded-t-lg" src="https://www.clarionledger.com/gcdn/presto/2019/02/01/PJAM/50282c97-c50b-4a9f-a562-1c4ee80a5af3-Challenge_8.jpg?width=700&height=438&fit=crop&format=pjpg&auto=webp" alt="" />
        </a>
        <div className="p-5">
            <a href="#">
